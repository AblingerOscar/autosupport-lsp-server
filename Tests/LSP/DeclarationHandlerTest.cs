...
using DeclarationParams = OmniSharp.Extensions.LanguageServer.Protocol.Models.DeclarationParams;
using TextDocumentIdentifier = OmniSharp.Extensions.LanguageServer.Protocol.Models.TextDocumentIdentifier;
using Position = OmniSharp.Extensions.LanguageServer.Protocol.Models.Position;
using DeclarationCapability = OmniSharp.Extensions.LanguageServer.Protocol.Client.Capabilities.DeclarationCapability;
...
namespace Tests.LSP
{
    public class DeclarationHandlerTest : BaseTest
    {
...
";
            ...
            var handler = new DeclarationHandler(docStore.Object);

            handler.SetCapability(new DeclarationCapability()
            {
